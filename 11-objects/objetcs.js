...
let netflix = {
 ...
 //console.log(netflix.season1.seasonInfo.episodeInfo [0]);  //<--- output names which season, which episode and the episode name
...
baking.cauliflower = 'get some hot sauce and cheese!console.log';
